...
public class ReportFragment extends SecuredNativeSmartRegisterCursorAdapterFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fromDatePicker.setAccentColor(ContextCompat.getColor(getActivity(), com.softmed.ccm_chw.R.color.colorPrimary));
        ...
        toDatePicker.setAccentColor(ContextCompat.getColor(getActivity(), com.softmed.ccm_chw.R.color.colorPrimary));
