package com.softmed.ccm_chw.Adapters;
...
import com.softmed.ccm_chw.Activities.ClientDetailsActivity;
...
public class ReferralClientsListAdapter extends
        RecyclerView.Adapter<ReferralClientsListAdapter.ViewHolder> {
    private static String TAG = ReferralClientsListAdapter.class.getSimpleName();
    private CommonRepository commonRepository;
    private List<Client> clients = new ArrayList<>();
    ;
    private Context mContext;

    public ReferralClientsListAdapter(Context context, List<Client> client) {
        clients = client;
        mContext = context;
