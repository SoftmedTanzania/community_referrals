...
import com.softmed.ccm_chw.Service.ReferralService;
import com.softmed.ccm_chw.Service.RegistrationIntentService;
import com.softmed.ccm_chw.util.AsyncTask;
import com.softmed.ccm_chw.util.SmallDiagonalCutPathDrawable;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.softmed.ccm_chw.R.layout.activity_login);
        ...
        findViewById(com.softmed.ccm_chw.R.id.credential_card).setBackground(new SmallDiagonalCutPathDrawable());
        ImageView v = (ImageView) findViewById(com.softmed.ccm_chw.R.id.background);
        Glide.with(getApplicationContext()).load(com.softmed.ccm_chw.R.drawable.clint_adair).into(v);
        setLanguage();
...
//        hideKeyboard();
    ...
    private void initializeLoginFields() {
        ...
        userNameEditText = (EditText) findViewById(com.softmed.ccm_chw.R.id.editTextUsername);
        passwordEditText = (EditText) findViewById(com.softmed.ccm_chw.R.id.editTextPassword);

        loginButton = (Button) findViewById(com.softmed.ccm_chw.R.id.buttonSignIn);
                ...
                if (loginResponse == SUCCESS) {
                    ...
                    if (loginResponse == null) {
                        ...
                        if (loginResponse == NO_INTERNET_CONNECTIVITY) {
                            showErrorDialog(getResources().getString(com.softmed.ccm_chw.R.string.no_internet_connectivity));
                        } else if (loginResponse == UNKNOWN_RESPONSE) {
                            showErrorDialog(getResources().getString(com.softmed.ccm_chw.R.string.unknown_response));
                        } else if (loginResponse == UNAUTHORIZED) {
                            showErrorDialog(getResources().getString(com.softmed.ccm_chw.R.string.unauthorized));
                        }
//                        showErrorDialog(loginResponse.message());
    ...
    private void showErrorDialog(String message) {
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle(getString(com.softmed.ccm_chw.R.string.login_failed_dialog_title))
                .setMessage(message)
