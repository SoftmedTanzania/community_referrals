...
import com.softmed.htmr_chw_staging.Service.ReferralService;
import com.softmed.htmr_chw_staging.Service.RegistrationIntentService;
import com.softmed.htmr_chw_staging.util.AsyncTask;
import com.softmed.htmr_chw_staging.util.SmallDiagonalCutPathDrawable;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.softmed.htmr_chw_staging.R.layout.activity_login);
        ...
        findViewById(com.softmed.htmr_chw_staging.R.id.credential_card).setBackground(new SmallDiagonalCutPathDrawable());
        ImageView v = (ImageView) findViewById(com.softmed.htmr_chw_staging.R.id.background);
        Glide.with(getApplicationContext()).load(com.softmed.htmr_chw_staging.R.drawable.clint_adair).into(v);
        setLanguage();
...
//        hideKeyboard();
    ...
    private void initializeLoginFields() {
        ...
        userNameEditText = (EditText) findViewById(com.softmed.htmr_chw_staging.R.id.editTextUsername);
        passwordEditText = (EditText) findViewById(com.softmed.htmr_chw_staging.R.id.editTextPassword);

        loginButton = (Button) findViewById(com.softmed.htmr_chw_staging.R.id.buttonSignIn);
                ...
                if (loginResponse == SUCCESS) {
                    ...
                    if (loginResponse == null) {
                        ...
                        if (loginResponse == NO_INTERNET_CONNECTIVITY) {
                            showErrorDialog(getResources().getString(com.softmed.htmr_chw_staging.R.string.no_internet_connectivity));
                        } else if (loginResponse == UNKNOWN_RESPONSE) {
                            showErrorDialog(getResources().getString(com.softmed.htmr_chw_staging.R.string.unknown_response));
                        } else if (loginResponse == UNAUTHORIZED) {
                            showErrorDialog(getResources().getString(com.softmed.htmr_chw_staging.R.string.unauthorized));
                        }
//                        showErrorDialog(loginResponse.message());
    ...
    private void showErrorDialog(String message) {
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle(getString(com.softmed.htmr_chw_staging.R.string.login_failed_dialog_title))
                .setMessage(message)
