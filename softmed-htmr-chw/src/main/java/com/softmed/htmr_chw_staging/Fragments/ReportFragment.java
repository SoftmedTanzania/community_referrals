...
public class ReportFragment extends SecuredNativeSmartRegisterCursorAdapterFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fromDatePicker.setAccentColor(ContextCompat.getColor(getActivity(), com.softmed.htmr_chw_staging.R.color.colorPrimary));
        ...
        toDatePicker.setAccentColor(ContextCompat.getColor(getActivity(), com.softmed.htmr_chw_staging.R.color.colorPrimary));
