...
public class mCareChildSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    private String[] buildFormNameList(){
        ...
        formNames.add("encc_visit_1");
        formNames.add("encc_visit_2");
        formNames.add("encc_visit_3");
